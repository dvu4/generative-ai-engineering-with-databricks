...
# MAGIC %pip install databricks-sdk textstat mlflow>=3.0 databricks-feature-engineering --upgrade
...
query_product_summary_system("Toward the beginning of my adventure, I was in a place of clouds. Big, puffy, pink-white ones that showed up sharply against the deep blue-black sky.Higher than the clouds—immeasurably higher—flocks of transparent, shimmering beings arced across the sky, leaving long, streamerlike lines behind them. Birds? Angels? These words registered later, when I was writing down my recollections. But neither of these words do justice to the beings themselves, which were quite simply different from anything I have known on this planet. They were more advanced. Higher forms. A sound, huge and booming like a glorious chant, came down from above, and I wondered if the winged beings were producing it. Again, thinking about it later, it occurred to me that the joy of these creatures, as they soared along, was such that they had to make this noise—that if the joy didn’t come out of them this way then they would simply not otherwise be able to contain it. The sound was palpable and almost material, like a rain that you can feel on your skin but does not get you wet. Alexander says that he traveled through this heaven, surrounded by millions of butterflies, with a woman. This woman gave him three messages: You are loved and cherished, dearly, forever, You have nothing to fear and There is nothing you can do wrong.") 
