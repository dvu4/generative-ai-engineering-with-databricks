...
# MAGIC
# MAGIC **distilbert-base-cased-distilled-squad modl: https://huggingface.co/distilbert/distilbert-base-cased-distilled-squad**
# MAGIC
# MAGIC For this notebook we'll use the <a href="https://huggingface.co/docs/transformers/v4.36.1/main_classes/pipelines" target="_blank">Hugging Face Pipeline</a> to use models for inference. 
...
# MAGIC
# MAGIC
# MAGIC **Refer to this link to get all the neccessary Parameters**
# MAGIC https://huggingface.co/docs/transformers/v4.36.1/en/main_classes/pipelines#transformers.QuestionAnsweringPipeline
...
# MAGIC     answers,
# MAGIC     ai_query(
# MAGIC       "databricks-claude-opus-4-1", 
